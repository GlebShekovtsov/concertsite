    ...
    <main class="main">
        <section class="section concert-about concert-about__section">
            <div class="container concert-about__container">
                ...
                $concertZalSelect = "SELECT * FROM `concert_zal` WHERE id_concert = '$concert'";
                ...
                foreach ($concertZalSelectResult as $concertZalRow) {
                    ...
                    echo "<a href='concert.php?concertid=&placeid=". $concertZalRow['id'] ."' class='sit__link'>" . "[Забронировать]" . "</a>";
                    echo "</li>";
                }
                echo "</ul>";
                ?>
